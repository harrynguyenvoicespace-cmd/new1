...
import { VertexRenderer } from '@/frontend/pages/studio/features/edit-mode/components/vertex-renderer';
import { EdgeRenderer } from '@/frontend/pages/studio/features/edit-mode/components/edge-renderer';
import { FaceRenderer } from '@/frontend/pages/studio/features/edit-mode/components/face-renderer';
import { ToolHandler } from '@/frontend/pages/studio/features/edit-mode/components/tool-handler';
import { Color, Vector3 } from 'three/webgpu';
import { useSelectionVertices } from '@/frontend/pages/studio/features/edit-mode/hooks/use-selection-vertices';
import { useSceneStore } from '@/stores/scene-store';
import { useLoopcut } from '@/frontend/pages/studio/features/edit-mode/hooks/use-loopcut';
import { useFilletPreview } from '@/frontend/pages/studio/features/edit-mode/hooks/use-fillet-preview';
// loopcut spans retained indirectly via existing hook usage (removed direct usage)
import { SculptHandler } from '@/frontend/pages/studio/features/edit-mode/components/sculpt-handler';
import { KnifeHandler } from '@/frontend/pages/studio/features/edit-mode/components/knife-handler';
import { unwrapMeshBySeams } from '@/utils/uv-mapping';
import { useEditModeContextMenu } from '@/frontend/pages/studio/features/edit-mode/hooks/use-edit-mode-context-menu';
import { useMarqueeSelection } from '@/frontend/pages/studio/features/edit-mode/hooks/use-marquee-selection';
import { useMarqueeOverlay } from '@/frontend/pages/studio/features/edit-mode/hooks/use-marquee-overlay';
import { useEditModeSelection } from '@/frontend/pages/studio/features/edit-mode/hooks/use-edit-mode-selection';
import EditModeContextMenu from '@/frontend/pages/studio/features/edit-mode/components/edit-mode-context-menu';
