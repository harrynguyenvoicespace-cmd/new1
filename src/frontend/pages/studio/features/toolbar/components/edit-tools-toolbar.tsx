...
export const EditToolsToolbar: React.FC = () => {
  ...
  return (
    <motion.div initial={{ y: -10, opacity: 0 }} animate={{ y: 0, opacity: 1 }}
      exit={{ y: -10, opacity: 0 }}
      className="pointer-events-auto rounded-[18px] border border-white/60 bg-[#8d8f92]/72 px-2 py-1 text-white shadow-[0_18px_38px_rgba(44,48,54,0.22)] backdrop-blur-2xl">
