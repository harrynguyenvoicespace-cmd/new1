...
const Panel = ({ className = '', children, ...rest }: HTMLMotionProps<"div">) => (
	<motion.div initial={{
		...
		x: -50, opacity: 0
	}} className={`bg-white/75 backdrop-blur-xl border border-white/70 rounded-[20px] shadow-[0_18px_48px_rgba(44,48,54,0.14)] w-64 h-full text-[#20242a] ${className}`} {...rest}>
		{children}
	</motion.div>
);
			...
			<ContextMenu.Root>
				...
				<ContextMenu.Portal container={portalContainer}>
					<ContextMenu.Positioner className="z-90">
						<ContextMenu.Popup
							className="z-[9999] min-w-48 rounded-xl border border-[#d7dbdd] bg-white/95 backdrop-blur-xl p-1 text-sm text-[#20242a] shadow-[0_18px_40px_rgba(44,48,54,0.18)]"
