...
import { ArraySettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/array-settings';
import { WeldSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/weld-settings';
import { TriangulateSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/triangulate-settings';
import { EdgeSplitSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/edge-split-settings';
import { DecimateSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/decimate-settings';
import { SolidifySettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/solidify-settings';
import { ScrewSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/screw-settings';
import { BevelSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/bevel-settings';
import { RemeshSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/remesh-settings';
import { MirrorSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/mirror-settings';
import { SubdivideSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/subdivide-settings';
import { VolumeToMeshSettings } from '@/frontend/pages/studio/features/properties-panel/components/tabs/modifiers/volume-to-mesh-settings';
